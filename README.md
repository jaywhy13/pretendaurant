...
- Engine interface control deficiences. It's difficult to pinpoint functionality for testing. For example, I want to test serving of customers. However, I'm forced to start the clock and let the generation of cashiers and customer happen. This is a problem because I can't control the generation of cashiers and customers. I need to be able to control the generation of cashiers and customers so I can test the serving of customers. This is a problem with the interface of the engine. I need to be able to control the generation of cashiers and customers so I can test the serving of customers. I need a way to provide my own cashiers and customers to the engine. The generation logic isn't configurable. I have to generate cashiers and so on.
